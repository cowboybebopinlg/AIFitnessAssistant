/**
 * @file This file contains a collection of SVG icon components used throughout the application.
 * Each icon is a React functional component that accepts standard SVG props.
 */
import React from 'react';

/**
 * Defines the common props for all SVG icon components.
 * It extends the standard SVG attributes.
 */
type IconProps = React.SVGProps<SVGSVGElement>;

/**
 * DashboardIcon component. Represents the dashboard or home screen.
 * @param {IconProps} props - The SVG props.
...
/**
 * DailyLogIcon component. Represents the daily logging feature.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * TrendsIcon component. Represents data trends and analytics.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * LibraryIcon component. Represents the user's library of exercises or foods.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * SettingsIcon component. Represents the application settings.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * CopyIcon component. Represents the action of copying text or data.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * RefreshCwIcon component. Represents refreshing or syncing data.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * ArrowLeftIcon component. Represents backward navigation.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * SearchIcon component. Represents a search action or input field.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * ChevronRightIcon component. Represents forward navigation or expansion.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * ChevronLeftIcon component. Represents backward navigation or collapsing.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * UserIcon component. Represents a user profile.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * StarIcon component. Represents a favorite or bookmarked item.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * BellIcon component. Represents notifications.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * LinkIcon component. Represents a hyperlink or connection.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * DatabaseIcon component. Represents data storage or import/export.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * UploadCloudIcon component. Represents uploading data to the cloud.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * AddIcon component. Represents an add action.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * TrashIcon component. Represents a delete or remove action.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * EditIcon component. Represents an edit action.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * SaveIcon component. Represents a save action.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * BookmarkIcon component. Represents a bookmark or save action.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * SparklesIcon component. Represents AI or a "magic" feature.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * DumbbellIcon component. Represents weightlifting or strength training.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * RunningIcon component. Represents running or cardio exercise.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * ClipboardIcon component. Represents a clipboard or paste action.
 * @param {IconProps} props - The SVG props.
 * @returns {JSX.Element} The rendered SVG icon.
 */
