...
const ProfilePage: React.FC = () => {
    ...
    const [trainingDayTargets, setTrainingDayTargets] = useState({ calories: '', protein: '', fat: '', fiber: '' });
    const [recoveryDayTargets, setRecoveryDayTargets] = useState({ calories: '', protein: '', fat: '', fiber: '' });
